package com.fastpay.jam.emailservice.service.helper.impl;
...
import com.fastpay.jam.emailservice.service.helper.FileHelper;
...
public class S3FileHelperImpl implements FileHelper {
    ...
    @Value("${aws_fastpay_files_bucket}")
    private String fastPayFilesBucket;
    // AWS Connection info bean
    @Autowired
    private FastPayAWSBean awsBean;
    ...
    public InputStream readFile(String fileName) throws FPGenericException {
        ...
        S3Object file = awsS3Client.getObject(new GetObjectRequest(fastPayFilesBucket, fileName));
        return file.getObjectContent();
    }

    public String getFastPayFilesBucket() {
        return fastPayFilesBucket;
    }
